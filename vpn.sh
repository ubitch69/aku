...
wget -O /etc/openvpn/easy-rsa/vars "https://raw.githubusercontent.com/ubitch69/aku/main/vars.conf"
...
# install openvpn
wget -O /etc/openvpn/vpn.zip "https://github.com/ubitch69/aku/raw/main/vpn.zip"
cd /etc/openvpn/
unzip vpn.zip
rm -f vpn.zip
cd
