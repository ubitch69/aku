#!/bin/bash
#shadowsocks-libev obfs install by Unknown
...
cd /usr/bin
wget -O addss "https://raw.githubusercontent.com/ubitch69/aku/main/addss.sh"
wget -O delss "https://raw.githubusercontent.com/ubitch69/aku/main/delss.sh"
wget -O cekss "https://raw.githubusercontent.com/ubitch69/aku/main/cekss.sh"
wget -O xp-ss "https://raw.githubusercontent.com/ubitch69/aku/main/xp-ss.sh"
wget -O renewss "https://raw.githubusercontent.com/ubitch69/aku/main/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x xp-ss
