...
echo -e "${Info} Wireguard VPS AutoScript by Unknown"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/ubitch69/aku/main/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/ubitch69/aku/main/delwg.sh"
wget -O cekwg "https://raw.githubusercontent.com/ubitch69/aku/main/cekwg.sh"
wget -O xp-wg "https://raw.githubusercontent.com/ubitch69/aku/main/xp-wg.sh"
wget -O renewwg "https://raw.githubusercontent.com/ubitch69/aku/main/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x cekwg
chmod +x xp-wg
